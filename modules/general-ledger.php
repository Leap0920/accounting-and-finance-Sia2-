...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-custom" aria-labelledby="modulesDropdown">
                            <li><a class="dropdown-item" href="general-ledger.php"><i
                                        class="fas fa-book me-2"></i>General Ledger</a></li>
                            <li><a class="dropdown-item" href="financial-reporting.php"><i
                                        class="fas fa-chart-line me-2"></i>Financial Reporting</a></li>
                            <li><a class="dropdown-item" href="loan-accounting.php"><i
                                        class="fas fa-hand-holding-usd me-2"></i>Loan Accounting</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="transaction-reading.php"><i
                                        class="fas fa-exchange-alt me-2"></i>Transaction Reading</a></li>
                            <li><a class="dropdown-item" href="expense-tracking.php"><i
                                        class="fas fa-receipt me-2"></i>Expense Tracking</a></li>
                            <li><a class="dropdown-item" href="payroll-management.php"><i
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-custom" aria-labelledby="settingsDropdown">
                            <li><a class="dropdown-item" href="bin-station.php"><i class="fas fa-trash-alt me-2"></i>Bin
                                    Station</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="database-settings.php"><i
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown d-none d-md-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom notifications-dropdown"
                        ...
                        <li><a class="dropdown-item text-center small" href="activity-log.php">View All
                                Notifications</a></li>
                    </ul>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom" aria-labelledby="userDropdown">
                        ...
                        <li><a class="dropdown-item" href="activity-log.php"><i class="fas fa-history me-2"></i>Activity
                                Log</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
    ...
    <main class="container-fluid py-4">
                    ...
                    <div class="col-lg-8">
                        <div class="header-content">
                            ...
                            <p class="page-subtitle-beautiful">
                                Monitor ledger health, track movements, and stay audit-ready with a curated snapshot of
                                every critical activity.
                            </p>
                        </div>
                    </div>
            ...
            <div class="table-actions-row">
                ...
                <div class="table-actions">
                    <div class="pagination-controls me-3">
                        ...
                        <select id="applications-per-page" class="form-select form-select-sm"
                            style="width: auto; display: inline-block;" onchange="changeApplicationsPerPage()">
            ...
            <div class="table-actions-row">
                ...
                <div class="table-actions">
                    <div class="pagination-controls me-3">
                        ...
                        <select id="accounts-per-page" class="form-select form-select-sm"
                            style="width: auto; display: inline-block;" onchange="changeAccountsPerPage()">
                            <option value="25" selected>25</option>
                            <option value="50">50</option>
                            <option value="75">75</option>
                            <option value="100">100</option>
                    ...
                    <button class="btn-action btn-action-outline" type="button"
                        onclick="exportAccounts()">Export</button>
        ...
        <div class="gl-section" id="transactions">
            ...
            <div class="table-actions-row">
                <span class="table-actions-hint" id="transactions-hint">Latest journal entries posted to the
                    ledger</span>
                <div class="table-actions">
                    <div class="pagination-controls me-3">
                        <label for="transactions-per-page" class="me-2">Show:</label>
                        <select id="transactions-per-page" class="form-select form-select-sm"
                            style="width: auto; display: inline-block;" onchange="changeTransactionsPerPage()">
                            <option value="25" selected>25</option>
                            <option value="50">50</option>
                            <option value="75">75</option>
                            <option value="100">100</option>
                    ...
                    <button class="btn-action btn-action-outline" type="button"
                        onclick="exportTransactions()">Export</button>
                    <button class="btn-action btn-action-outline" type="button"
            ...
            <div class="table-actions-row">
                ...
                <div class="table-actions">
                    <div class="pagination-controls me-3">
                        ...
                        <select id="audit-per-page" class="form-select form-select-sm"
                            style="width: auto; display: inline-block;" onchange="changeAuditPerPage()">
                            <option value="25" selected>25</option>
                            <option value="50">50</option>
                            <option value="75">75</option>
                            <option value="100">100</option>
                    ...
                    <button class="btn-action btn-action-outline" type="button"
                        onclick="exportAuditTrail()">Export</button>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="6" class="text-center py-4">
                                <p class="text-muted">Select date range and click "Generate Report" to view trial
                                    balance</p>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="table-actions-row">
                ...
                <div class="table-actions">
                    <div class="pagination-controls me-3" id="trial-balance-pagination" style="display: none;">
                        ...
                        <select id="trial-balance-per-page" class="form-select form-select-sm"
                            style="width: auto; display: inline-block;" onchange="changeTrialBalancePerPage()">
                            <option value="25" selected>25</option>
                            <option value="50">50</option>
                            <option value="75">75</option>
                            <option value="100">100</option>
                    ...
                    <button class="btn-action btn-action-outline" type="button" onclick="exportTrialBalance()"
                        id="exportTrialBalanceBtn" style="display: none;">
                        <i class="fas fa-download me-1"></i>Export
                    </button>
                    <button class="btn-action btn-action-outline" type="button" onclick="printTrialBalance()"
                        id="printTrialBalanceBtn" style="display: none;">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger d-none" id="voidJournalEntryBtn"
    ...
    <div class="modal fade" id="applicationDetailModal" tabindex="-1" aria-labelledby="applicationDetailModalLabel"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-danger" id="declineApplicationBtn"
                        onclick="showDeclineReasonModal()">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="rejectionReason" rows="4"
                            placeholder="Please provide a reason for declining this application..." required></textarea>
                        <small class="form-text text-muted">This reason will be stored with the application
                            record.</small>
                    </div>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-footer border-0 justify-content-center pb-4">
                    ...
                    <button type="button" class="btn btn-success px-4" id="confirmApproveBtn"
                        onclick="executeApproveApplication()">
