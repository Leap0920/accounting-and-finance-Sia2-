...
<body>
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <div class="header-info-card">
                            <div class="info-item">
                                <div class="info-icon">
                                    <i
                                        class="fas fa-<?php echo $connection_status === 'connected' ? 'check-circle text-success' : 'times-circle text-danger'; ?>"></i>
                                </div>
                        ...
                        <?php if ($connection_status === 'connected'): ?>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <span
                                        class="text-muted"><?php echo htmlspecialchars($db_info['name'] ?? 'Unknown'); ?></span>
                                </div>
                                <div class="col-6">
                                    <strong>Version:</strong><br>
                                    <span
                                        class="text-muted"><?php echo htmlspecialchars($db_info['version'] ?? 'Unknown'); ?></span>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
            ...
            <div class="card-body">
                            ...
                            <thead class="table-light">
                                <tr>
                                    <th>
                                        ...
                                        <input type="text" class="form-control form-control-sm mt-2" id="tableSearch"
                            ...
                            <tbody>
                                ...
                                if (!empty($tables)) {
                                    ...
                                    foreach ($tables as $table):
                                        ...
                                        ?>
                                        <tr data-table-name="<?php echo $table_name_lower; ?>"
                                            class="<?php echo $isAccountingTable ? 'table-primary' : ''; ?>">
                                            <td>
                                            ...
                                            <td>
                                                <?php if (!empty($modules) && is_array($modules)): ?>
                                                    ...
                                                    foreach ($module_slice as $module):
                                                        ...
                                                        ?>
                                                        <span
                                                            class="badge bg-secondary mb-1"><?php echo htmlspecialchars($module, ENT_QUOTES, 'UTF-8'); ?></span>
                                                    <?php endforeach; ?>
                                                    <?php if (count($modules) > 2): ?>
                                                        <span class="badge bg-light text-dark"
                                                            title="<?php echo htmlspecialchars(implode(', ', $modules), ENT_QUOTES, 'UTF-8'); ?>">
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-primary"
                                                    onclick="analyzeTable('<?php echo addslashes($table_name); ?>')"
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-3">
                                            <i class="fas fa-info-circle me-2"></i>No tables found in database. Please check
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Unable to retrieve table statistics. Please check your database connection.
                        </p>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="modal fade" id="tableAnalysisModal" tabindex="-1" aria-labelledby="tableAnalysisModalLabel"
        aria-hidden="true">
